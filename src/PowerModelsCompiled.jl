...
export increment32, increment64, c_load_grid, c_solve_power_flow
...
Base.@ccallable function c_solve_power_flow(path::Cstring)::Cstring
    ...
    return malloc_cstring(julia_path)
end
...
# #     julia_path = unsafe_string(path)
# #     try
# #         println("Loading grid from $julia_path")
# #         # Uncomment when using PowerModels:
# #         # load_grid(julia_path)
# #         return 0  # Success
# #     catch e
# #         println("Error loading grid: ", e)
